...
public class TimeManager : MonoBehaviour {
	...
	public class WorldTime {
		public enum DayParts {MORNING, AFTERNOON, EVENING, NIGHT};
		public enum DaysOfWeek {MONDAY, TUESDAY, WENDSDAY, THURSDAY, FRIDAY, SATERDAY, SUNDAY};
		public enum Months {JANUARY, FEBURARY, MARCH, APRIL, MAY, JUNE, JULY, AUGUST, SEPTEMBER, OCTOBER, NOVMBER, DECMBER};
